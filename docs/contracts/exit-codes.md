...
| `4`   | `NOT_A_CARGO_WORKSPACE` | A lifecycle provider command that requires a cargo workspace was invoked outside one, such as a Rust provider setup or workflow.                                      |
